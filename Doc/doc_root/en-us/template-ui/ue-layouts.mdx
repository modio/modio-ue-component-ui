...
### [WBP_ModioDefaultTOSDialog](/unreal/ui-refdoc#wbp_modiodefaulttosdialog)

![the TOS dialog](img/modiotosdialog.png)

Use this component to easily implement a [Terms of Use](https://docs.mod.io/terms) dialog.
