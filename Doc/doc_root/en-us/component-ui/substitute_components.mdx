...
* [Wrapping an existing widget](https://docs.mod.io/unreal/component-ui/custom-components#wrapping-an-existing-widget)
* [Creating a new widget](https://docs.mod.io/unreal/component-ui/custom-components#creating-a-new-widget)
* [Subclassing an existing widget](https://docs.mod.io/unreal/component-ui/custom-components#subclassing-an-existing-widget)

These techniques are explained in detail in [Creating Custom Components](https://docs.mod.io/unreal/component-ui/custom-components).
...
Now you know how to sustitute an existing component, you may want to create your own componen for specific purposes. Check out our [Creating Custom Components](https://docs.mod.io/unreal/component-ui/custom-components) guide. 