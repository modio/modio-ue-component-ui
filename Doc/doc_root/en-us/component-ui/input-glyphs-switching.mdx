...
2. Install Game Development Kit (GDK):
   - Refer to [Microsoft's GDK documentation](https://learn.microsoft.com/en-us/gaming/gdk/docs/gdk-dev/pc-dev/tutorials/get-started-with-unreal-pc/gc-get-started-with-unreal-pc) for access and installation (only necessary for Engineers).
