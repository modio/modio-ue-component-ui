...
Once you are satisfied with your simple mod browser, [Initialize](https://docs.mod.io/unreal/initialization) the mod.io plugin using your game's API key and Game ID, and add your new widget to the viewport so users can [Search for UGC](https://docs.mod.io/unreal/searching-ugc).

To learn how to switch existing components in and out, check out our [Substituting Components](https://docs.mod.io/unreal/component-ui/substitute-components) guide.
