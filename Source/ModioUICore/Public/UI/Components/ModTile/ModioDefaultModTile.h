...
/**
 * @default_impl_for Mod Tile
 * @brief This is a default implementation of the Mod Tile component which is intended to represent an individual mod in
 * Mod List and Mod Tile View components. 
 * @component_display_name Mod Tile
 */
UCLASS()
class MODIOUICORE_API UModioDefaultModTile : public UModioUIComponentBase,
...
protected:
	...
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category = "mod.io|UI|Mod Tile", meta = (BlueprintProtected))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "mod.io|UI|Mod Tile", meta = (BlueprintProtected))
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "mod.io|UI|Mod Tile", meta = (BlueprintProtected))
	void PopulateExtraOptionsCommands(TArray<UObject*>& Commands, UObject* Context);

#if WITH_EDITORONLY_DATA
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "mod.io|UI|Data Binding|Mod Tile",
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "mod.io|UI|Mod Tile|Widget Getters",
			  meta = (BlueprintProtected))
